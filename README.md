...
1. Explain what a token is used for.
   // It is a unique indentifier to access some service.
2. What steps can you take in your web apps to keep your data secure?
   // Require a token from the user and protect my routes to only users with token (authorization) can access them.
3. Describe how web servers work.
   // They store, process requests and responses and deliver data to clients.
4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   // Create, read, update and delete (Post, Get, Put and Delete). 
